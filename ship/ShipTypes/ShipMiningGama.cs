...
{
    public class ShipMiningGama : ShipBase
    {
        ...
        public ShipMiningGama(ContentManager content, Vector2 startPosition)
            : base(content, startPosition)
        {
            ...
            Texture = content.Load<Texture2D>("spaceShips/ShipMiningGama");
