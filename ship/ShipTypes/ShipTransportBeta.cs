...
{
    public class ShipTransportBeta : ShipBase
    {
        ...
        public ShipTransportBeta(ContentManager content, Vector2 startPosition)
            : base(content, startPosition)
        {
            ...
            Texture = content.Load<Texture2D>("spaceShips/ShipTransportBeta");
