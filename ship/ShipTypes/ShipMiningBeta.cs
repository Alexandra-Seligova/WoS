...
{
    public class ShipMiningBeta : ShipBase
    {
        ...
        public ShipMiningBeta(ContentManager content, Vector2 startPosition)
            : base(content, startPosition)
        {
            ...
            Texture = content.Load<Texture2D>("spaceShips/ShipMiningBeta");
