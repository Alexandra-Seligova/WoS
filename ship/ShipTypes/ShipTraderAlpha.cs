...
{
    public class ShipTraderAlpha : ShipBase
    {
        ...
        public ShipTraderAlpha(ContentManager content, Vector2 startPosition)
            : base(content, startPosition)
        {
            ...
            Texture = content.Load<Texture2D>("spaceShips/ShipTraderAlpha");
