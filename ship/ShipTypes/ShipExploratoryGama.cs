...
{
    public class ShipExploratoryGama : ShipBase
    {
        ...
        public ShipExploratoryGama(ContentManager content, Vector2 startPosition)
            : base(content, startPosition)
        {
            ...
            Texture = content.Load<Texture2D>("spaceShips/ShipExploratoryGama");
