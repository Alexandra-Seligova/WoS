...
{
    public class ShipMiningAlpha : ShipBase
    {
        ...
        public ShipMiningAlpha(ContentManager content, Vector2 startPosition)
            : base(content, startPosition)
        {
            ...
            Texture = content.Load<Texture2D>("spaceShips/ShipMiningAlpha");
